...
class TestExchangeModel:
    ...
    def test_is_currently_open_during_trading_hours(self):
        exchange = ExchangeFactory(
            timezone="America/New_York",
            open_time=datetime.time(9, 30),
            close_time=datetime.time(16, 0),
    ...
    def test_is_currently_open_outside_trading_hours(self):
        exchange = ExchangeFactory(
            timezone="America/New_York",
            open_time=datetime.time(9, 30),
            close_time=datetime.time(16, 0),
    ...
    def test_is_currently_open_on_weekend(self):
        exchange = ExchangeFactory(
            timezone="America/New_York",
            open_time=datetime.time(9, 30),
            close_time=datetime.time(16, 0),
    ...
    def test_is_currently_open_with_invalid_timezone(self):
